#
#  Be sure to run `pod spec lint featureflowiossdk.podspec' to ensure this is a
...
# Or just: s.author    = "mmattini"
# s.authors            = { "mmattini" => "maxmattini@gmail.com" }
# s.social_media_url   = "http://twitter.com/mmattini"
